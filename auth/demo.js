            ...
            <View style={{
              ...
              >
                <View style={[s.modalINNER]}>
                  <View>
                    <Text style={[s.text2, s.shadow, s.white]}>SIGN UP FOR BETTER EXPERIENCE ?</Text>
                  </View>
                  <TextInput
                    style={[s.TextInputt]}
                ...
                <Button style={{ height: 50, width: 70, justifyContent: 'center', marginTop: 1, marginLeft: 120 }} danger onPress={() => { this.signup(email, password, conpass) }}>
          ...
          <View style={[s.modal]}>
            <View style={{
              ...
              >
                <View style={[s.modalINNER]}>
                  <View>
                    <Text style={[s.text2, s.shadow, s.white]}>SIGN IN FOR BETTER EXPERIENCE ?</Text>
                  </View>
                  <TextInput
                    style={[s.TextInputt]}
                    onChangeText={email => this.setState({ email })}
                ...
                <Button style={{ height: 50, width: 70, justifyContent: 'center', marginTop: 1, marginLeft: 120 }} danger onPress={() => { this.signin(email, password) }}>
